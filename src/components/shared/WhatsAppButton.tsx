...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 flex items-center gap-2 bg-[#25D366] text-white px-4 py-3 shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 group"
    >
      {/* WhatsApp SVG icon */}
      <svg
